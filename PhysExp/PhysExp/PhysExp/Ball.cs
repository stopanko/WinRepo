...
namespace PhysExp
{
    public class Ball
    {
        ...
        public void InitBallContent(ContentManager Content)
        {
            //Content.RootDirectory = "Content";
            _circleSprite = Content.Load<Texture2D>("CircleSprite"); //текстура
            ...
            _circleBody = BodyFactory.CreateCircle(_world, ConvertUnits.ToSimUnits(_circleSprite.Height / 2f), 1f, ConvertUnits.ToSimUnits(new Vector2(50, 50))); // (світ, радіус(визнач за текстурою), шось,початкова позиція тіла)
